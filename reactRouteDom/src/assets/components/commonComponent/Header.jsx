        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-4 col-6 text-end order-md-2 order-2">
            <div class="d-flex justify-content-end align-items-center">
              <a class="btn btn-link text-dark d-none d-md-inline-block">Categories</a>
              <a href="#" class="btn btn-link text-dark d-none d-md-inline-block">Deals</a>
               <a class="btn btn-link text-dark d-none d-md-inline-block">Logout</a>
              {/* {
                userId
                ?
              ...
              <a class="btn btn-link text-dark position-relative">
