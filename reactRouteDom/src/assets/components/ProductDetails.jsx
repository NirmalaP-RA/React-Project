...
export default function ProductDetails() {
    ...
    // useParams() hook use to get value in three ways:by id id(/:id), by slug(/:slug),optional value(/:id/:slug?)
    // if i want then i can also get 2 params value for that we use/:slug means by definig two keys
    // like:path="products/product-details/:id/:slug"
    // console.log(params);
    let [productDetails,setProductDetails]=useState('');
    // use to give  that particular single product details useState('')
    // you can use codepan website:https://codepen.io/cloudyweather89/pen/yLEYybV to get code of any page creation of product dtails etc.
    useEffect(()=>{
        axios.get("https://wscubetech.co/ecommerce-api/productdetails.php?id="+params.id)
        // to pass value dynamically what we do is 'api' +parms.id after that save data in state and do display work
        .then((response)=>{
            ...
            <div class="col-md-5">
                <div class="main-img">
                    ...
                    <div class="row my-3 previews">
                      ...
                      {/* here we we are doing dynamic image process under product details */}
                        {/* <div class="col-md-3">
